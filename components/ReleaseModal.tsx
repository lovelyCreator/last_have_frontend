...
export default function ReleaseModal({ open, setOpen, mintId, level, methodOfLeaving }: any) {
            ...
            >
              <Dialog.Panel className="relative w-full lg:w-1/3 text-white  transform overflow-hidden rounded-lg bg-black p-10 text-left shadow-xl transition-all ">
                <div className="w-full flex flex-col gap-10 items-center justify-center">
                  <img
                    src={"https://cdn.hellomoon.io/public/marius/" + mintId + ".png"}
                  ...
                  {loadingRelease ? (
                    ...
                    {methodOfLeaving === 1 && (
                      ...
                      >
                        <div>RELEASE FOR </div>
                        <div className="flex items-center justify-center gap-1 ">
                          <img src="/coin.png" className="w-[25px]" /> 40 000
                        </div>
                      </button>
                    )}
...
const LevelStats = ({ level }: any) => {
  ...
  const multiplier = Math.pow(2, level - 2);
